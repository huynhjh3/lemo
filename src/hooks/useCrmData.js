...
export function useCrmData() {
  ...
  return {
    ...
    bypassPreInstallChecklist: withRefresh(companiesApi.bypassPreInstallChecklist),
    undoBypassPreInstallChecklist: withRefresh(companiesApi.undoBypassPreInstallChecklist),
